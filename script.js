const courses = [
  ...
  { name: "Bases perinatales y ginecológicas en matronería", unlocks: ["Integrador I", "Neonatología, lactancia y gestión"] },
  { name: "Cuidados médico-quirúrgicos de matronería II", unlocks: ["Salud sexual, salud reproductiva y gestión I", "Integrador I"] },
  { name: "Políticas en salud sexual y salud reproductiva", unlocks: ["Salud sexual, salud reproductiva y gestión I", "Integrador I", "Neonatología, lactancia y gestión", "Psicología integral y técnicas de entrevista clínica", "Educación con enfoque curso de vida", "Salud familiar y comunitaria", "Metodología de la investigación", "Matronería legal y bioética"] },
  { name: "Pensamiento crítico", unlocks: [] },
  { name: "Inglés 3", unlocks: ["Inglés 4", "Integrador I"] },
  ...
  { name: "Integrador I", unlocks: [] },
  { name: "Inglés 4", unlocks: [] },
  ...
  { name: "Educación con enfoque curso de vida", unlocks: ["Integrador II", "Imagenología en matronería", "Matronería oncológica y reproducción asistida"] },
  { name: "Matronería patológica integrada y gestión", unlocks: ["Integrador II", "Imagenología en matronería", "Matronería oncológica y reproducción asistida"] },
  ...
  { name: "Metodología de la investigación", unlocks: ["Integrador II", "Imagenología en matronería", "Matronería oncológica y reproducción asistida", "Proyecto de Matronería"] },
  { name: "Sexología, género y derecho", unlocks: ["Integrador II", "Imagenología en matronería", "Matronería oncológica y reproducción asistida"] },
  { name: "Intervención en contextos sociales y comunitarios", unlocks: ["Integrador II", "Imagenología en matronería", "Matronería oncológica y reproducción asistida"] },
  { name: "Matronería legal y bioética", unlocks: ["Integrador II", "Imagenología en matronería", "Matronería oncológica y reproducción asistida"] },
  { name: "Integrador II", unlocks: ["Habilitación profesional I", "Habilitación profesional II"] },
